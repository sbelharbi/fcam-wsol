...
class UnetPlusPlus(SegmentationModel):
    """Unet++ is a fully convolution neural network for image semantic
    ...
    Args:
        ...
        encoder_depth: A number of stages used in encoder in range [3, 5]. Each
